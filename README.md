# TechBridge — Homepage (Task 1)

Homepage for TechBridge by Baselink Services Limited, built for the TechBridge Web Development Internship, Task 1.
...
short "link to be added" note beneath them. Swap in the real links in `index.html`:
- Search for `Open the application form` to update the application link.
